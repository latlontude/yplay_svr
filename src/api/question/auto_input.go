...
type AutoInputReq struct {
	Uin   int64  `schema:"uin"`
	Token string `schema:"token"`
	Ver   int    `schema:"ver"`
}

type AutoInputRsp struct {
}

//
func doAutoInput(req *AutoInputReq, r *http.Request) (rsp *AutoInputRsp, err error) {
	//去除首位空白字符
	AutoInput()
...
func AutoInput() (uids []int64, err error) {
	...
	xlsx, err := excelize.OpenFile("/home/work/yplay_svr/etc/random_question.xlsx")
	if err != nil {
