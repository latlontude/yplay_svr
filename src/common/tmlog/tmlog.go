...
func (l *Logger) Notice(v ...interface{}) {
	l.sync_msg(LOG_TYPE_NOTICE, fmt.Sprintln(v...))
}

func (l *Logger) Noticef(format string, v ...interface{}) {
	l.sync_msg(LOG_TYPE_NOTICE, fmt.Sprintf(format, v...))
}

// info is alias of notice
...
func (l *Logger) Trace(v ...interface{}) {
	l.sync_msg(LOG_TYPE_TRACE, fmt.Sprintln(v...))
}

func (l *Logger) Tracef(format string, v ...interface{}) {
	l.sync_msg(LOG_TYPE_TRACE, fmt.Sprintf(format, v...))
}
...
func (l *Logger) Debug(v ...interface{}) {
	l.sync_msg(LOG_TYPE_DEBUG, fmt.Sprintln(v...))
}

func (l *Logger) Debugf(format string, v ...interface{}) {
	l.sync_msg(LOG_TYPE_DEBUG, fmt.Sprintf(format, v...))
}
...
func (l *Logger) Fatal(v ...interface{}) {
	l.sync_msg(LOG_TYPE_FATAL, fmt.Sprintln(v...))
}

func (l *Logger) Fatalf(format string, v ...interface{}) {
	l.sync_msg(LOG_TYPE_FATAL, fmt.Sprintf(format, v...))
}
...
func (l *Logger) Warning(v ...interface{}) {
	l.sync_msg(LOG_TYPE_WARNING, fmt.Sprintln(v...))
}

func (l *Logger) Warningf(format string, v ...interface{}) {
	l.sync_msg(LOG_TYPE_WARNING, fmt.Sprintf(format, v...))
}

func (l *Logger) Error(v ...interface{}) {
	l.sync_msg(LOG_TYPE_ERROR, fmt.Sprintln(v...))
}

func (l *Logger) Errorf(format string, v ...interface{}) {
	l.sync_msg(LOG_TYPE_ERROR, fmt.Sprintf(format, v...))
}
...
func (l *Logger) sync_msg(log_type int, log_msg string) error {
	...
	//println("In sync_msg G_Log_V", G_Log_V)
	if Log_Is_Debug() {
...
func (l *Logger) pad_msg(log_type int, log_msg string) string {
	...
	//获取调用的 函数/文件名/行号 等信息
	/*fcName*/
	_, log_filename, log_lineno, ok = runtime.Caller(3)
	if !ok {
	...
	//拼装返回
	log_format_str = "%s %s [%s] (%s:%d) %s\n"
	log_ret_str = fmt.Sprintf(log_format_str, log_date_time, log_id, log_type_str, log_filename, log_lineno /*log_callfunc, */, log_msg)
...
func Log_Run(RunConfigMap map[string]string) {
	...
	//fmt.Println("before G_Log_V new")

	//初始化全局变量
	if G_Log_V == nil {
		G_Log_V = new(Log_T)

		//fmt.Println("new G_Log_V")
	}
...
func Log_Is_Debug() bool {
	if G_Log_V != nil && G_Log_V.LogDebugOpen {
		return true
	}
	return false
}
