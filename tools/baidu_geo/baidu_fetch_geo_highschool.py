...
cursor.execute('select schoolId, schoolType, schoolName, province, city,district from schoolsOrgs where schoolType = 2 and latitude = 0')

baiduAk="YYR9I0YW5xSMrm2miKYLt7fxuxfGtSrT"

for e in cursor.fetchall():
    schoolId, schoolType, school, province, city, district = e
    ...
    print tag, schoolId, schoolType, school, province, city, district
